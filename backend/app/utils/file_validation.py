...
_MAGIC_BYTES: dict[str, tuple[bytes, ...]] = {
    ...
    # Eski .doc formatı (OLE Compound File)
...
# Bazı HTTP istemcileri (ör. bazı mobil multipart kütüphaneleri) .docx/.doc için
...
def matches_magic_bytes(content: bytes, content_type: str | None) -> bool:
    """Dosya içeriğinin beyan edilen tipe ait bilinen bir imzayla başlayıp başlamadığını kontrol eder."""
